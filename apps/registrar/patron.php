...
<span class='patron_list' title="Click to add new event to list."><b>Patron registrar</b></span>
<div id="div_jstree"></div>
<script>
<?php
$mySQL = new db_mysql();

$sql = "select id, '#' parent, concat(lastname, ' ', firstname) `text`, '{\"class\":\"patron_list\"}' a_attr from user order by lastname, firstname, email";
